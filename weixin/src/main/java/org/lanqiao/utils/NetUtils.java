...
public class NetUtils {
    public static final String APPID = "wx7bda6d3547b7211a";
    public static final String APPSECRET = "78a9940429ea5e06fcb7243b30a6fa7a";
    ...
    public static String getAutoChat(String Content) throws IOException {
        String url = AUTO_CHAT.replace("Content", Content);
